...
{
    public partial class YetkiliSifreDegistir : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (sr.Read())
            {
                ...
                if (_kayitlisifre == _mevcut)
                {
                    ...
                    {
                        con.Open();
                        MySqlCommand kmd = new MySqlCommand("UPDATE uyeler SET uye_sifre='" + _yeni + "' WHERE uye_ogrencino='" + YetkiliGiris.gkadi + "'", con);
                        kmd.ExecuteNonQuery();
                        con.Close();
                        MessageBox.Show("Şifre Güncellendi.", "Başarılı", MessageBoxButtons.OK, MessageBoxIcon.Question);
                        this.Close();
                        YetkiliGirisEkranı f5 = new YetkiliGirisEkranı();
                        f5.Show();
                    }
                    else
                    {
